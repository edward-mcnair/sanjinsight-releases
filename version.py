...
# ── Version number ────────────────────────────────────────────────────────────
__version__    = "1.5.0-beta.3"
PRERELEASE     = "beta.3"           # empty string "" for GA releases
VERSION_TUPLE  = (1, 5, 0)          # numeric-only, for < / > comparisons
BUILD_DATE     = "2026-04-02"       # set by CI/CD on release; update manually otherwise
