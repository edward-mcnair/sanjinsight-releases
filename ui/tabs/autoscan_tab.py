...
class AutoScanTab(QWidget):
    ...
    def _build_left(self) -> QWidget:
        ...
        # ── Modality badge (derived from active camera type) ───────────
        # Camera switching is handled by the global CameraContextBar in the
        # app header — this badge just reflects the current modality.
        ...
        self._voltage.setSuffix("  V"); self._voltage.setMinimumWidth(90)
        self._current = QDoubleSpinBox()
        self._current.setRange(-5, 5); self._current.setDecimals(4)
        self._current.setSuffix("  A"); self._current.setMinimumWidth(90)
        ...
        self._exposure.setSuffix("  ms"); self._exposure.setMinimumWidth(90)
        self._n_frames = QSpinBox()
        self._n_frames.setRange(5, 500); self._n_frames.setValue(20)
        self._n_frames.setSuffix("  frames"); self._n_frames.setMinimumWidth(90)
        self._settle = QDoubleSpinBox()
        self._settle.setRange(0.1, 30); self._settle.setValue(0.5)
        self._settle.setSuffix("  s"); self._settle.setMinimumWidth(90)
